...
/**
 * NavigatorGeos provides the ability to navigate imagery in the
 * GEOS projection.  This method pretty much wraps GEOSnav, which
 * is essentially a math copy of the McIDAS source module
 * nvxgeos.dlm.
 *
 * @version 1.6 6 Aug 1999
 * @author Tommy Jasmin, SSEC, and Tom Whittaker
 */

class NavigatorGeos implements Navigator {

  private GEOSnav ng = null;
  ...
  {
    // create a GEOSnav object - this will do all the work
    ng = new GEOSnav(navBlock);
